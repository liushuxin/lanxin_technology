...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "static/js/" + ({"0":"testmodule"}[chunkId]||chunkId) + ".chunk.js";
...
var _get_data = __webpack_require__(1);
...
var getStr = function getStr(arr) {
    return arr.join("");
};
exports.default = getStr;
